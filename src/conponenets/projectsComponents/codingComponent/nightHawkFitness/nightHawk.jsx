...
export const Hawk = () =>{
    return <div className="hawkInfoContainer">
        ...
        <h4 className="aligner">&ensp;&ensp;    A comprehensive fitness app that can track your weight, create and log your workouts, and help you track your calories with the nutrituinix.com API. This project was completed with me and my team of three other students throughout the Spring of 2023.</h4>
        ...
        to create applications that have a purpose in the real world. This course is completed mostly without instructor aid and forces students to learn new technologies and skills while also applying them simultaneously.
        ...
        &#40;special thanks to Minh for being a great leader&#41; and we came out at the end of this class not just alive, but with a project we could be proud of. This project inspired me to focus my attention on web development and overall,
